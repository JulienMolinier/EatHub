...
public class RestaurantRVAdapter extends RecyclerView.Adapter<RestaurantFeedHolder> {
    ...
    public void onBindViewHolder(@NonNull RestaurantFeedHolder restaurantFeedHolder, int i) {
        ...
        restaurantFeedHolder.itemView.setOnClickListener((View v) -> {
            ...
            myIntent.putExtra("currentRestaurant", restaurantList.get(i));
            myIntent.putExtra("currentProfile", profile);
            context.startActivity(myIntent);
        });

        restaurantFeedHolder.getCVCall().setOnClickListener((View v) -> {
